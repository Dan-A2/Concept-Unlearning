...
if __name__ == "__main__":
    ...
    if args.nu > 0.0:
        save_path = SCRIPT_DIR / f"checkpoints/adaptive_rmu/{args.bench_label}/{args.model_name}_nu"
    else:
        save_path = SCRIPT_DIR / f"checkpoints/adaptive_rmu/{args.bench_label}/{args.model_name}"
    if save_path.exists():
