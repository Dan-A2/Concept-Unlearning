...
if __name__ == "__main__":
    ...
    if args.nu > 0.0:
        save_path = SCRIPT_DIR / f"checkpoints/npo/{args.bench_label}/{args.retain_loss_fn}-{args.model_name}_nu"
    else:
        save_path = SCRIPT_DIR / f"checkpoints/npo/{args.bench_label}/{args.retain_loss_fn}-{args.model_name}"
    if save_path.exists():
